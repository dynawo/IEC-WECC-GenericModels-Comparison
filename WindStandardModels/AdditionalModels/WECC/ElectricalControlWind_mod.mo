...
model ElectricalControlWind_mod "WECC Wind Electrical Control REEC"
  /*
  ...
  import Dynawo.Dynawo.Types;
  extends WindStandardModels.AdditionalModels.WECC.ElectricalControlCommon_mod(varLimPIDFreeze.Ni = Ni, limPIDFreeze.Ni = Ni, limPIDFreeze.Xi0 = UInj0Pu, varLimPIDFreeze.Xi0 = QInj0Pu/UInj0Pu);
  
  parameter Dynawo.Types.VoltageComponent VDLIp11;
  parameter Dynawo.Types.VoltageComponent VDLIp12;
  parameter Dynawo.Types.VoltageComponent VDLIp21;
  parameter Dynawo.Types.VoltageComponent VDLIp22;
  parameter Dynawo.Types.VoltageComponent VDLIp31;
  parameter Dynawo.Types.VoltageComponent VDLIp32;
  parameter Dynawo.Types.VoltageComponent VDLIp41;
  parameter Dynawo.Types.VoltageComponent VDLIp42;
  parameter Dynawo.Types.VoltageComponent VDLIq11;
  parameter Dynawo.Types.VoltageComponent VDLIq12;
  parameter Dynawo.Types.VoltageComponent VDLIq21;
  parameter Dynawo.Types.VoltageComponent VDLIq22;
  parameter Dynawo.Types.VoltageComponent VDLIq31;
  parameter Dynawo.Types.VoltageComponent VDLIq32;
  parameter Dynawo.Types.VoltageComponent VDLIq41;
  parameter Dynawo.Types.VoltageComponent VDLIq42;
  parameter Dynawo.Types.VoltageComponent VDLIpPoints[:, :] = [VDLIp11, VDLIp12; VDLIp21, VDLIp22; VDLIp31, VDLIp32; VDLIp41, VDLIp42] "Pair of points for voltage-dependent active current limitation piecewise linear curve [u1,y1; u2,y2;...]";
  parameter Dynawo.Types.VoltageComponent VDLIqPoints[:, :] = [VDLIq11, VDLIq12; VDLIq21, VDLIq22; VDLIq31, VDLIq32; VDLIq41, VDLIq42] "Pair of points for voltage-dependent reactive current limitation piecewise linear curve [u1,y1; u2,y2;...]";
  parameter Dynawo.Types.PerUnit VRef1Pu "User-defined reference/bias on the inner-loop voltage control in pu (base UNom) (typical: 0 pu)";
  parameter Dynawo.Types.Time HoldIpMax "Time delay for which the active current limit (ipMaxPu) is held after voltage dip in s";
  parameter Dynawo.Types.Time HoldIq "Absolute value of HoldIq defines seconds to hold current injection after voltage dip ended. HoldIq < 0 for constant, 0 for no injection after voltage dip, HoldIq > 0 for voltage-dependent injection (typical: -1 .. 1 s)";
  parameter Dynawo.Types.PerUnit IqFrzPu "Constant reactive current injection value in pu (base UNom, SNom) (typical: -0.1 .. 0.1 pu)";
  parameter Boolean PFlag "Power reference flag: const. Pref (0) or consider generator speed (1)";
  
  Modelica.Blocks.Interfaces.RealInput omegaGPu(start = Dynawo.Electrical.SystemBase.omegaRef0Pu) "Generator frequency from drive train control in pu (base omegaNom)" annotation(
  ...
  WindStandardModels.AdditionalModels.WECC.IqInjectionLogic_mod iqInjectionLogic(IqFrzPu = IqFrzPu, HoldIq = HoldIq) annotation(

...
model IqInjectionLogic_mod "Reactive Current Injection Logic"

  parameter Dynawo.Types.CurrentModulePu IqFrzPu "Constant reactive current injection value in pu (base SNom, UNom)";
  parameter Dynawo.Types.Time HoldIq "Absolute value of HoldIq defines seconds to hold current injection after voltage dip ended. HoldIq < 0 for constant, 0 for no injection after voltage dip, HoldIq > 0 for voltage-dependent injection";
  ...
  Dynawo.Types.Time vDipInjEndTime(start = -1) "ending time of the voltage dip start (in seconds)";

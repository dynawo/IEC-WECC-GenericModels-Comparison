...
model ElectricalControlCommon_mod "WECC Electrical Control REEC common"
  ...
  WindStandardModels.AdditionalModels.Blocks.LimPIDFreeze_mod limPIDFreeze( K = Kqp,Ti = Kqp / Kqi, Xi0 = UInj0Pu / Kqp, Y0 = UInj0Pu, YMax = VMaxPu, YMin = VMinPu) annotation(
  ...
  Dynawo.Electrical.Controls.WECC.BaseControls.VoltageCheck voltageCheck(UMinPu = UMinPu, UMaxPu = UMaxPu) annotation(
    Placement(visible = true, transformation(origin = {-230, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  WindStandardModels.AdditionalModels.Blocks.VarLimPIDFreeze_mod varLimPIDFreeze(Ti = Kvp / Kvi, K = Kvp, Xi0 = QInj0Pu / UInj0Pu / Kqp, Y0 = QInj0Pu / UInj0Pu) annotation(
...
end ElectricalControlCommon_mod;
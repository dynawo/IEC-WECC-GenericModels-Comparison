...
model QControl_mod "Reactive power control module for wind turbines (IEC N°61400-27-1)"
  /*
  ...
  */
  ...
  parameter Dynawo.Types.PerUnit XWT0Pu "Initial reactive power or voltage reference at grid terminal in pu (base SNom or UNom) (generator convention)" annotation(
    Dialog(tab = "Operating point"));
  WindStandardModels.AdditionalModels.Blocks.AntiWindupIntegrator_arw antiWindupIntegrator_arw1(DyMax = 999, K = Kpu, Ni = Ni, Y0 = -Q0Pu*Dynawo.Electrical.SystemBase.SnRef/(SNom*U0Pu), YMax = IqMaxPu, YMin = IqMinPu, tI = 1/Kiu)  annotation(
    Placement(visible = true, transformation(origin = {158, 244}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  WindStandardModels.AdditionalModels.Blocks.AntiWindupIntegrator_arw antiWindupIntegrator_arw(DyMax = 999, K = Kpq, Ni = Ni, Y0 = U0Pu, YMax = UMaxPu, YMin = UMinPu, tI = 1/Kiq)  annotation(

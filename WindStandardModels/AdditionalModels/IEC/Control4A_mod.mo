...
model Control4A_mod "Whole generator control module for type 4A wind turbines (IEC N°61400-27-1)"
  /*
  ...
  */
  ...
  parameter Dynawo.Types.PerUnit IMaxPu "Maximum current module at converter terminal in pu (base UNom, SNom)" annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Dynawo.Types.PerUnit IMaxDipPu "Maximum current module during voltage dip at converter terminal in pu (base UNom, SNom)" annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Dynawo.Types.PerUnit Kpqu "Gain of reactive current limit when the voltage is high (base UNom, SNom)" annotation(
    Dialog(tab = "CurrentLimiter"));
  ...
  parameter Dynawo.Types.PerUnit IqMin0Pu "Initial minimum reactive current at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));
  parameter Dynawo.Types.ReactivePowerPu QMax0Pu "Initial maximum reactive power at grid terminal in pu (base SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));
  parameter Dynawo.Types.ReactivePowerPu QMin0Pu "Initial minimum reactive power at grid terminal in pu (base SNom) (generator convention)" annotation(
    Dialog(group = "Initialization"));

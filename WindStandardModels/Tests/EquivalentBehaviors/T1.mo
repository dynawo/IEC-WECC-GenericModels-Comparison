...
model T1 "Active power step with equivalent parameters"
  ...
  Dynawo.Electrical.Lines.Line line_WECC(BPu = 0, GPu = 0, RPu = 0, XPu = 0.1) annotation(
    Placement(visible = true, transformation(origin = {-14, -26}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
...
equation
  ...
  connect(WECC_WT4B.terminal, line_WECC.terminal1) annotation(
    Line(points = {{-33, -27}, {-25, -27}, {-25, -26}}, color = {0, 0, 255}));
  ...
  connect(line_WECC.terminal2, bus_WECC.terminal) annotation(
    Line(points = {{-3, -26}, {18, -26}}, color = {0, 0, 255}));
  connect(xWTrefPu.y, WECC_WT4B.QRefPu) annotation(
    Line(points = {{-100, 16}, {-92, 16}, {-92, -38}, {-68, -38}}, color = {0, 0, 127}));
  annotation(
    uses(Dynawo(version = "1.5.0"), Modelica(version = "3.2.3")),

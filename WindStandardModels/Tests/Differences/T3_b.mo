...
model T3_b "Larger voltage set point modification with equivalent parameters"
  ...
  Modelica.Blocks.Sources.Step xWTrefPu(height = 0.09, offset = 1, startTime = 1) annotation(
